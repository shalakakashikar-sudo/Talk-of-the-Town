  ...
  return (
    <div className="mt-8 bg-indigo-950/40 border-l-4 border-indigo-400 p-6 rounded-2xl shadow-lg backdrop-blur-md animate-fade-in group hover:bg-indigo-900/40 transition-colors border border-white/5">
      <div className="flex items-center space-x-4 mb-3">
        ...
        <h4 className="text-indigo-300 font-black text-[9px] uppercase tracking-[0.3em] group-hover:text-indigo-200 transition-colors">Linguistic Feedback</h4>
      </div>
      <blockquote className="text-gray-200 text-sm md:text-base italic font-medium leading-relaxed border-l-2 border-white/10 pl-5 py-1 whitespace-pre-wrap">
        {note}
      </blockquote>
